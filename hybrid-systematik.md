...
**Ebene 2, die Daten (`opsteuerung.json`, `katalog2026.json`, `erloes2026.json`).** `HDRG_REGELN` bleibt die Kodequelle, künftig mit Feld `quelle` je Kode („DH 2026 I20-V70" oder „GFFC WE 04.03.2026") und Kommentar zur Tabellenbezeichnung (A13). Neu, ohne bestehende Felder zu ändern: `HDRG_FALLREGELN` (H-02: Alter, PCCL, VWD, Pflegegrad, beidseitig mit Liste V67, Diagnosen V11, DFS, Nerv), `HDRG_VERDRAENGUNG` (H-03: Rangzahlen der DRGs aus DH S. 409/411, nach V1/V2 bestätigt). Katalog: erledigt 13.09.2026 (3h); Regel ab jetzt: Änderung nur in `data/OPS_Katalogdaten_2026_MASTER.xlsx` (Blätter Katalog, KX, Kommentar, Meta, Aenderungslog), JSON ausschließlich per `scripts/build_katalog2026.py`, Prüfung mit `--check`.
